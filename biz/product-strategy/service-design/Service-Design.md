...
aliases: ["Service Design", "서비스 설계"]
---

# 서비스 설계와 UX 패턴

서비스 설계 원칙과 개별 UX 패턴 — 사용자에게 보이는 층위의 설계 레퍼런스.
...
- [x] [[UI-Terminology|UI 용어 정리]] — GNB, 팝업 vs 모달, 컨펌 vs 알럿, 터치 제스처 9종
- [x] [[UX-Laws|UX 심리학 10가지 법칙]] — 제이콥, 피츠, 힉, 테슬러, 도허티 임계와 백엔드 연결
