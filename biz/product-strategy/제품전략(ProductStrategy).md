...
- [x] [[Community-Strategy|커뮤니티 전략 (여정별 효과, 유무형 가치, UGC 동기와 감정 동인, 시드/자생력/친목질 방지)]]
- [x] [[D2C-Brand-Strategy|D2C와 브랜드 데이터 전략 (플랫폼 위협 4가지, 데이터 3축: 상품/주문/사용)]]
- [x] [[Metoo-Strategy|Me-too 서비스 기획 (멘탈모델 보존 + 자산 기반 차별화, 프로세스 단계도)]]
- [x] [[Service-Design|서비스 설계와 UX 패턴 (service-design/ 폴더 인덱스)]] — 설계 10원칙, 게이미피케이션, 다크 패턴, 페이지네이션
