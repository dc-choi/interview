...
커머스 도메인 지식 — 거래 구조, 플랫폼 유형, 핵심 도메인 영역(회원, 상품, 가격, 주문).
...
- [x] [[Commerce-Revenue-Formula|수익 공식]] — 방문수 × 전환율 × 객단가와 비용, 부가 수익원
- [x] [[Payment-Service|결제 서비스]] — 카드 결제 4단계(주문서, 인증, 승인, 매입), PG와 VAN, 간편결제 토큰, 페이 스펙트럼, 카드 네트워크 4대 역할과 interchange 수수료 경제, 결제 데이터 시야
- [x] [[In-App-Purchase|인앱결제]] — 결제수단 vs 결제시스템, 앱마켓 수수료의 가격 전가, 독점 규제
