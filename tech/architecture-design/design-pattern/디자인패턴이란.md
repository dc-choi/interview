...
- [[tech/architecture-design/design-pattern/create/factory/Factory패턴이란|Factory]]
- [[tech/architecture-design/design-pattern/create/builder/Builder패턴이란|Builder]]
- [[tech/architecture-design/design-pattern/create/singleton/Singleton패턴이란|Singleton]]
- [[tech/architecture-design/design-pattern/create/revealing-constructor/RevealingConstructor패턴이란|Revealing Constructor]]

### 구조 패턴
구조를 유연하고 효율적으로 유지하면서 객체와 클래스를 더 큰 구조로 조합합니다.

- [[tech/architecture-design/design-pattern/structure/proxy/Proxy패턴이란|Proxy]]
- [[tech/architecture-design/design-pattern/structure/decorator/Decorator패턴이란|Decorator]]
- [[tech/architecture-design/design-pattern/structure/adapter/Adapter패턴이란|Adapter]]

### 행동 패턴
객체 간의 효과적인 의사소통과 책임 할당을 처리합니다.

- Observer
- [[tech/architecture-design/design-pattern/behavior/strategy/Strategy패턴이란|Strategy]]
- [[tech/architecture-design/design-pattern/behavior/state/State패턴이란|State]]
- [[tech/architecture-design/design-pattern/behavior/template-method/TemplateMethod패턴이란|Template Method]]
- [[tech/architecture-design/design-pattern/behavior/iterator/Iterator패턴이란|Iterator]]
- [[tech/architecture-design/design-pattern/behavior/middleware/Middleware패턴이란|Middleware]]
- [[tech/architecture-design/design-pattern/behavior/command/Command패턴이란|Command]]
