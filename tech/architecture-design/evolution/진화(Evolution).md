...
## 목차
- [x] [[microservice|마이크로서비스 전환 (모놀리스 vs MSA, 준비도, 분해, 경계 조합, 데이터 소유권, 모듈러 모노리스)]] — 서브폴더 인덱스
...
- [x] [[Compatibility-Design|호환성 설계 (API 버저닝, 전후방 호환과 스키마 진화)]] — 서브폴더 인덱스
...
- [x] [[ADR|ADR (Architecture Decision Record)]]
