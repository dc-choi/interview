...
- [x] [[Hexagonal-In-Practice|Hexagonal 실전 적용 (Port/Adapter, Driving/Driven, CQS, 데이터 캐리어, NestJS 매핑)]]
...
- [x] [[DTO-Layering|DTO 레이어 스코프 · Entity 변환 위치 (Controller/Service/Mapper 3안, Repository는 Entity만)]]
