...
- [[tech/web/network/네트워크(Network)|네트워크 (Network)]] — TLS, OSI 계층과 캡슐화(소켓, 스트림, MTU/MSS, DPI), IP 헤더, LAN과 WAN, L2 스위치 계층과 업링크, 라우팅과 NAT, 응용 프로토콜(DHCP, DNS, SSH, 메일), 패킷 캡처와 Wireshark, TCP(헤더, 핸드셰이크, 흐름/오류 제어), Loopback, Browser URL Flow
