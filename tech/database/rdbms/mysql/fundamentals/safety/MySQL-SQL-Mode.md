...
- [MySQL 5.7 Release Notes, Changes in MySQL 5.7.8](https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-8.html)
- [MySQL 9.7 Reference Manual, Server SQL Modes](https://dev.mysql.com/doc/refman/9.7/en/sql-mode.html)
