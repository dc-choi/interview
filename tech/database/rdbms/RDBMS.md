...
- [x] [[MySQL-Migration-and-Comparison|MySQL 마이그레이션과 제품 비교 폴더 인덱스 (utf8mb4 전환, PostgreSQL 이기종 이관, 엔진 비교)]]
...
## Oracle
- [x] [[oracle|Oracle Database 폴더 인덱스 (SQL과 PL/SQL, tablespace, 권한, index, 데이터 딕셔너리, 11g 역사 자료)]]
- [x] [[Oracle-SQL-and-PL-SQL|Oracle SQL과 PL/SQL 폴더 인덱스 (SQL 방언, sequence와 계층형 query, PL/SQL 기본기와 저장 프로그램)]]
