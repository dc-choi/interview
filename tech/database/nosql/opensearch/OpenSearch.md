...
- [ ] 0단계 통과 보류: 도입 판단의 지식 확인은 마쳤지만, 시작 전 실물 단계의 네 요청을 먼저 통과한 뒤 완료로 계산한다.
...
- [OpenSearch Documentation, Introduction to OpenSearch](https://docs.opensearch.org/latest/getting-started/intro/)
...
- [OpenSearch Documentation, Doc values mapping parameter](https://docs.opensearch.org/latest/mappings/mapping-parameters/doc-values/)
- [OpenSearch Documentation, Creating a cluster](https://docs.opensearch.org/latest/tuning-your-cluster/)
