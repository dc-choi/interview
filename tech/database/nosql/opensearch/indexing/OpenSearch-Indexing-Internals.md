...
- [OpenSearch Documentation, Delete Document API](https://docs.opensearch.org/latest/api-reference/document-apis/delete-document/)
- [OpenSearch Documentation, Get Document API](https://docs.opensearch.org/latest/api-reference/document-apis/get-documents/)
- [OpenSearch Documentation, Source metadata field](https://docs.opensearch.org/latest/mappings/metadata-fields/source/)
- [OpenSearch Documentation, Refresh index](https://docs.opensearch.org/latest/api-reference/index-apis/refresh/)
- [OpenSearch Documentation, Flush](https://docs.opensearch.org/latest/api-reference/index-apis/flush/)
- [OpenSearch Documentation, Force merge](https://docs.opensearch.org/latest/api-reference/index-apis/force-merge/)
...
- [OpenSearch Documentation, Update Settings API](https://docs.opensearch.org/latest/api-reference/index-apis/update-settings/)
...
- [OpenSearch Documentation, Put Mapping API](https://docs.opensearch.org/latest/api-reference/index-apis/put-mapping/)
