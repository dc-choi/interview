...
- [OpenSearch Documentation, Index template APIs](https://docs.opensearch.org/latest/api-reference/index-apis/index-templates/)
- [OpenSearch Documentation, Index templates](https://docs.opensearch.org/latest/im-plugin/index-templates/)
...
- [OpenSearch Documentation, Roll over index](https://docs.opensearch.org/latest/api-reference/index-apis/rollover/)
- [OpenSearch Documentation, Data streams](https://docs.opensearch.org/latest/im-plugin/data-streams/)
- [OpenSearch Documentation, Index State Management](https://docs.opensearch.org/latest/im-plugin/ism/index/)
- [OpenSearch Documentation, ISM policies와 rollover action](https://docs.opensearch.org/latest/im-plugin/ism/policies/)
- [AWS Documentation, OpenSearch Service 운영 모범 사례](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/bp.html)
- [AWS Documentation, UltraWarm storage](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ultrawarm.html)
- [AWS Documentation, Cold storage](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cold-storage.html)
- [AWS Documentation, OpenSearch Service ISM](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ism.html)
