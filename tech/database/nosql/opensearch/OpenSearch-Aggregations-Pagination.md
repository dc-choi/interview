...
- [OpenSearch Documentation, Global aggregation](https://docs.opensearch.org/latest/aggregations/bucket/global/)
- [OpenSearch Documentation, Implementing faceted search in OpenSearch](https://docs.opensearch.org/latest/tutorials/faceted-search/)
- [OpenSearch Documentation, Filter search results](https://docs.opensearch.org/latest/search-plugins/filter-search/)
- [PostgreSQL Documentation, Table Expressions (GROUPING SETS)](https://www.postgresql.org/docs/current/queries-table-expressions.html)
- [PostgreSQL Documentation, WITH Queries (Common Table Expressions)](https://www.postgresql.org/docs/current/queries-with.html)
- [OpenSearch Documentation, Filtering vector search results](https://docs.opensearch.org/latest/vector-search/filter-search-knn/index/)
- [OpenSearch Documentation, Hybrid search with post-filtering](https://docs.opensearch.org/latest/vector-search/ai-search/hybrid-search/post-filtering/)
- [OpenSearch Documentation, Terms aggregation](https://docs.opensearch.org/latest/aggregations/bucket/terms/)
- [OpenSearch Documentation, Composite aggregation](https://docs.opensearch.org/latest/aggregations/bucket/composite/)
- [OpenSearch Documentation, Cardinality aggregation](https://docs.opensearch.org/latest/aggregations/metric/cardinality/)
- [OpenSearch Documentation, Paginate results](https://docs.opensearch.org/latest/search-plugins/searching-data/paginate/)
- [OpenSearch Documentation, Point in Time](https://docs.opensearch.org/latest/search-plugins/searching-data/point-in-time/)
- [OpenSearch Documentation, Point in Time API](https://docs.opensearch.org/latest/api-reference/search-apis/point-in-time-api/)
- [OpenSearch Documentation, Sort results](https://docs.opensearch.org/latest/search-plugins/searching-data/sort/)
- [OpenSearch Documentation, Asynchronous search](https://docs.opensearch.org/latest/search-plugins/async/)
- [OpenSearch Documentation, Index rollups](https://docs.opensearch.org/latest/im-plugin/index-rollups/index/)
- [OpenSearch Documentation, Concurrent segment search](https://docs.opensearch.org/latest/search-plugins/concurrent-segment-search/)
