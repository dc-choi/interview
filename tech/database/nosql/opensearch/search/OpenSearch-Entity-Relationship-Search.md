...
- [Terms query - OpenSearch Documentation](https://docs.opensearch.org/latest/query-dsl/term/terms/)
- [SQL and PPL limitations - OpenSearch Documentation](https://docs.opensearch.org/latest/sql-and-ppl/limitation/)
- [Joining queries - OpenSearch Documentation](https://docs.opensearch.org/latest/query-dsl/joining/index/)
- [Has child query - OpenSearch Documentation](https://docs.opensearch.org/latest/query-dsl/joining/has-child/)
- [Derived field type - OpenSearch Documentation](https://docs.opensearch.org/latest/mappings/supported-field-types/derived/)
- [Script query - OpenSearch Documentation](https://docs.opensearch.org/latest/query-dsl/specialized/script/)
- [Multi-match queries - OpenSearch Documentation](https://docs.opensearch.org/latest/query-dsl/full-text/multi-match/)
- [Nested field type - OpenSearch Documentation](https://docs.opensearch.org/latest/mappings/supported-field-types/nested/)
- [Join field type - OpenSearch Documentation](https://docs.opensearch.org/latest/mappings/supported-field-types/join/)
- [Update mapping API - OpenSearch Documentation](https://docs.opensearch.org/latest/api-reference/index-apis/put-mapping/)
- [Update by query API - OpenSearch Documentation](https://docs.opensearch.org/latest/api-reference/document-apis/update-by-query/)
