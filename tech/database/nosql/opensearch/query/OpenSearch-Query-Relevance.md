...
- [OpenSearch Documentation, Query and filter context](https://docs.opensearch.org/latest/query-dsl/query-filter-context/)
- [OpenSearch Documentation 2.19, Term query](https://docs.opensearch.org/2.19/query-dsl/term/term/)
- [OpenSearch Documentation, Full-text queries](https://docs.opensearch.org/latest/query-dsl/full-text/index/)
- [OpenSearch Documentation, Combined fields query](https://docs.opensearch.org/latest/query-dsl/full-text/combined-fields/)
...
- [OpenSearch Documentation, Explain API](https://docs.opensearch.org/latest/api-reference/search-apis/explain/)
- [OpenSearch Documentation, Profile API](https://docs.opensearch.org/latest/api-reference/search-apis/profile/)
