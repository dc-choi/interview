...
- [x] [[tech/database/orm/ORM-Impedance-Mismatch|ORM과 임피던스 불일치]]
- [x] [[tech/database/orm/Aggregate-Boundary|Aggregate 경계와 데이터 접근]]
- [x] [[tech/database/orm/ORM|ORM 기초]]
- [ ] [[tech/database/orm/Domain-Model|Domain Model]]

## RDB (OLTP)
- [x] [[tech/database/rdbms/Schema-Design|Schema design]]
...
- [x] [[tech/database/rdbms/Sorting-Operations|정렬이 발생하는 5가지 연산]]
- [x] [[Prepared-Statement-Cache|Prepared Statement 캐시 폭발 (동적 쿼리 함정, MySQL+Node.js 사례)]]
- [x] [[tech/database/rdbms/Data-Dictionary|데이터 딕셔너리(Oracle vs MySQL)]]
- [ ] [[Partitioning]]
- [x] [[Sharding]]
...
- [x] [[tech/database/rdbms/Business-Logic-App-vs-DB|비즈니스 로직 위치 (App vs DB, Stored Procedure 기피, 확장성 비대칭)]]
