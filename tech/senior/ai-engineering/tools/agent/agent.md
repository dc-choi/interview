...
- [x] [[Agent-Spec-Writing|에이전트 스펙 작성법 (6대 영역, 지시의 저주, 3단계 경계, LLM-as-a-Judge)]]
...
- [x] [[Agent-Coding-Guardrails|LLM 코딩 가드레일 (실패 패턴과 교정 4원칙 — 가정 표면화, 최소 코드, 수술적 변경, 성공 기준 검증 루프, CLAUDE.md/스킬/Cursor rule 주입)]]
