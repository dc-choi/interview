---
tags: [senior, ai, claude-code, index]
status: index
category: "Senior - AI 엔지니어링"
aliases: ["Claude Code", "클로드 코드"]
---

# Claude Code 가이드

AI 코딩 에이전트 Claude Code를 실무에 태우는 방법 — 기초 운영부터 개발 워크플로우, 사무/도메인 자동화, 커스터마이즈, 레퍼런스까지. 관통하는 두 축은 **자율권을 신뢰 수준에 맞춰 단계적으로 올리기**와 **권장(CLAUDE.md)과 강제(Hook)의 분리**. 상위: [[tools|AI 엔지니어링 실천 도구]].
