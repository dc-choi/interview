---
tags: [senior, ai, market, moat, distribution, strategy, index]
status: index
category: "Senior - AI 엔지니어링"
aliases: ["AI Market and Moat", "AI 시장 구도와 해자"]
---

# AI 시장 구도와 해자

생성형 AI 시장 점유율 재편, 프론티어 인프라 접근권을 둘러싼 권력 지형, 그리고 쉽게 복제되지 않는 방어력 — 도달력과 데이터 플라이휠. 상위: [[org-role|AI 시대 조직, 역할]].
