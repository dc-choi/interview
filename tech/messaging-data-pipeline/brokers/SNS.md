...
| **Subscriber Protocol** | SQS, Lambda, HTTPS, Email, SMS, Mobile Push, Amazon Data Firehose |
...
- **재시도 정책**: HTTP/S Subscriber는 Delivery Policy로 재시도 횟수와 백오프를 조정할 수 있다. 사용자 정의 정책의 총 재시도 시간은 최대 3,600초
...
- SNS vs EventBridge 선택 기준
- HTTP/S Subscriber 재시도 정책과 Delivery Policy의 최대 총 재시도 시간
