...
장애를 예방하고, 발생했을 때 대응하고, 끝난 뒤 학습으로 바꾸는 운영 체계를 모았다. SRE 방법론이 전체 틀을 잡고, 부하가 장애의 성격을 어떻게 바꾸는지와 N-1 가용량 헤드룸 같은 사전 경보 지표가 예방 축을, 장애 복구 설계와 등급별 대응 절차가 대응 축을, RCA와 포스트모템 문화가 학습 축을 맡는다.
