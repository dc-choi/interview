...
- [x] [[External-Integration|외부 연동 복원력 (Timeout/Bulkhead/Circuit, 재시도 백오프와 지터, 조회형과 거래형 패턴, 수집 파이프라인, 결제 5원칙)]]
- [x] [[Incident-Lifecycle|장애 대응 라이프사이클 폴더 인덱스 (SRE, 부하에 따른 장애 진화, N-1 헤드룸, 복구와 재발 방지, 핫픽스 판단, RCA / Postmortem)]]
