...
> 조회일 2026-07-15 기준 정리. 연령, 신원 검증 규제는 관할별로 개정, 시행 연기, 소송 결과에 따른 변동성이 크다. 아래 시행일과 조항은 방향 파악용이며, 실제 컴플라이언스 판단 전에는 각 1차 규제기관(Ofcom, European Commission, FTC, eSafety 등)의 원문을 반드시 재확인한다.
...
| 호주 | 연령 제한 소셜미디어가 16세 미만의 계정 보유를 막기 위한 reasonable steps 적용, 자기신고만으로는 불충분하며 계층적 age assurance 권고 | 2025-12-10 | 법인 민사 벌금 최대 A$49.5M |
...
- 최소 권한 IAM (컴퓨트 KYC = 접근 제어) (작성 예정: `Least-Privilege-IAM`)
...
- [eSafety Commissioner — Social Media Minimum Age Regulatory Guidance](https://www.esafety.gov.au/sites/default/files/2025-09/eSafety-SMMA-Regulatory-Guidance.pdf)
- [Federal Register of Legislation — Online Safety Amendment (Social Media Minimum Age) Act 2024](https://www.legislation.gov.au/C2024A00127/latest)
