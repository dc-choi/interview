...
- [x] [[Thread-Pool-Sizing|Thread pool sizing]] — 기존 보강: [[External-Service-Resilience|Bulkhead와 자원 격리]], [[OpenSearch-Performance-Troubleshooting|Thread pool과 429 진단]]
...
- [x] [[Hot-Partition|Hot partition 대응]] — 기존 보강: [[Geospatial-Matching|H3와 Kafka 파티션 hotspot]], [[Consistent-Hashing|Hot Spot 대응]], [[OpenSearch-Performance-Troubleshooting|hot shard 진단]]
