...
| **고객 관리형 키** (Customer Managed) | 고객 | 활성화·비활성화·삭제·정책 모두 가능 | 옵션 (1년·연 1회 자동 로테이션) | 키당 월 $1 |
...
|------|---------------|----------------|
| 자동 로테이션 | **강제 1년 주기** | 옵션 (활성화 시 1년 주기) |
...
- **자동 로테이션 주기** — AWS 관리형은 강제 1년, 고객 관리형은 옵션 1년
