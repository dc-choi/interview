...
- [AWS Documentation, Sizing Amazon OpenSearch Service domains](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/sizing-domains.html)
- [AWS Documentation, Choosing instance types and testing](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/bp-instances.html)
- [AWS Documentation, Supported instance types](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
- [AWS Documentation, OpenSearch Service quotas, EBS gp3와 Java process 한도](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html)
- [AWS Documentation, Dedicated master nodes](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-dedicatedmasternodes.html)
- [AWS Documentation, Dedicated coordinator nodes](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/Dedicated-coordinator-nodes.html)
- [AWS Documentation, k-NN search in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/knn.html)
- [AWS Documentation, CloudWatch metrics for OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-cloudwatchmetrics.html)
...
- [OpenSearch Documentation, Vector search settings](https://docs.opensearch.org/latest/vector-search/settings/)
- [OpenSearch Documentation, Methods and engines, memory estimation](https://docs.opensearch.org/latest/field-types/supported-field-types/knn-methods-engines/)
