...
- [x] [[AWS|EC2 (Nitro·Instance Store·Placement Group·IMDSv2·T 시리즈 크레딧·AMI·ENA·Key Pair·Lifecycle)]]
...
- [x] [[RDS-Security-Group|RDS Security Group 구성 (SG 참조·계층별 방화벽·IaC)]]
- [x] [[RDS-Aurora|RDS / Aurora · 관리형 DB (Multi-AZ·Read Replica·Failover·백업/PITR·RDS Proxy·Aurora Endpoint·Global DB)]]
- [x] [[RDS-Monitoring|RDS 모니터링 (CloudWatch·Performance Insights·Slow Query → Slack 알람)]]
...
- [x] [[OpenSearch|OpenSearch (전문 검색·로그 분석·DynamoDB 검색 보완·k-NN/Vector)]]
