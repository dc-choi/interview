---
tags: [testing, jest, nestjs, spring, index]
status: index
category: "테스트&품질(Testing&Quality)"
aliases: ["Framework Testing", "프레임워크 테스트"]
---

# 프레임워크 테스트(Framework Testing)

Jest와 Express, NestJS, Spring — 프레임워크가 제공하는 테스트 도구와 DI 컨테이너 위에서 경계를 정해 검증하는 방법.
