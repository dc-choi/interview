...
- [AWS Documentation, Solution overview](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/solution-overview.html)
- [AWS Documentation, Architecture details](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/architecture-details.html)
- [AWS Documentation, Service log analytics pipeline](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/service-log-analytics-pipeline.html)
- [AWS Documentation, Application log analytics pipeline](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/application-log-analytics-pipeline.html)
- [AWS Documentation, Supported AWS services](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/supported-aws-services.html)
- [AWS Documentation, Getting started](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/getting-started.html)
- [AWS Documentation, Uninstall the solution](https://docs.aws.amazon.com/solutions/latest/centralized-logging-with-opensearch/uninstall-the-centralized-logging-with-opensearch.html)
