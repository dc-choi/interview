---
tags: [ai, organization, small-team, problem-definition, productivity]
status: done
...
3분의 1은 고정 규칙이 아니다. 발견 불확실성, 구현 리드 타임, 팀 크기에 맞춰 조정한다. **정의되지 않은 일과 구현 중인 일을 같은 의존 사슬에 묶지 않는 것**이 중요하다.
