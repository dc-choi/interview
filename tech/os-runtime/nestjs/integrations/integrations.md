---
tags: [nestjs, graphql, microservices, websocket, cache]
status: index
category: "OS & Runtime - NestJS"
aliases: ["NestJS Integrations", "NestJS 통합"]
---

# NestJS 통합 (integrations 인덱스)

HTTP REST 바깥의 프로토콜, 외부 시스템과 NestJS를 연결하는 패턴들을 모은다.
...
- [[NestJS-Events-and-Jobs|이벤트와 잡 — @nestjs/event-emitter, @nestjs/bullmq, @nestjs/schedule]]
