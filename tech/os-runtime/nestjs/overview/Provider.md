...
이러한 기술에 대한 자세한 내용은 [[Injection-Scopes|Injection Scope]]에서 확인할 수 있습니다.
...
공급자를 정의하는 더 많은 예제는 [[Custom-Provider|종속성 주입]]챕터 에서 확인하세요.
...
기존 인스턴스를 검색하거나 Provider를 동적으로 인스턴스화하려면 [[Module-reference|모듈 참조]]를 사용할 수 있습니다.
