...
- [[Spring-Core|Spring Core (객체 설계, container와 metadata, 등록과 자동 주입, scope와 lifecycle, AOP proxy 기초, IoC 전체 흐름 개요)]]
- [[Spring-AOP|Spring AOP (proxy factory, 자동 proxy, advice, pointcut과 실전 한계)]]
