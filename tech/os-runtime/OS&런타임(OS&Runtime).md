...
## OS 기초
- [x] [[tech/os-runtime/os-fundamentals/Concurrency-and-Process|동시성과 프로세스 (커널, 동기화, 데드락, Node.js 동기화)]]
- [x] [[tech/os-runtime/os-fundamentals/Concurrency-vs-Parallelism|동시성 · 병렬성 (구조 vs 실행, Actor/CSP 채널, 런타임별 선택)]]
- [x] [[tech/os-runtime/os-fundamentals/Storage-and-FileSystem|기억장치와 파일시스템 (HDD, SSD, 주변장치, 디스크 할당)]]
- [x] [[tech/os-runtime/os-fundamentals/Process-Lifecycle|Process lifecycle (PCB, 상태, fork/exec, 좀비, 쓰레드, 컴파일)]]
- [x] [[tech/os-runtime/os-fundamentals/Context-Switching|Context switching (CPU 스케줄링, FIFO, SJF, RR, MLFQ)]]
- [x] [[tech/os-runtime/os-fundamentals/Virtual-Memory|Virtual memory (세그멘테이션, 페이징, 디맨드 페이징, 페이지 교체)]]

## Linux
- [x] [[tech/os-runtime/linux/Linux-File-System|Linux 파일 시스템 · 디렉토리 구조 (FHS, /etc·/var·/usr, everything is a file)]]
- [ ] [[Page-Cache|Page cache]]
- [ ] [[File-Descriptor-Limit|File descriptor limit]]
- [ ] [[Epoll-Kqueue|epoll / kqueue]]

## Runtime
- [x] [[tech/os-runtime/runtime/Thread-vs-Event-Loop|Thread vs Event Loop (멀티스레드 패턴, CPU 캐시, Lock, Node.js)]]
- [x] [[tech/os-runtime/runtime/Async-IO|Async I/O (이벤트 루프/워커풀 차단 방지, REDOS, 보안, 프로파일링)]]
- [x] [[tech/os-runtime/runtime/Sync-Async-Blocking|동기·비동기·블로킹·논블로킹 (2×2 조합, 제어권 vs 결과 처리)]]
- [x] [[tech/os-runtime/runtime/Async-vs-Threads|async/await vs 스레드 (컬러 함수, 백프레셔, 가상 스레드, 구조적 동시성)]]
- [x] [[tech/os-runtime/runtime/Backpressure|Backpressure (스트림 배압, highWaterMark, pipe 수명주기)]]
...
## JVM
- [x] [[tech/os-runtime/jvm/GC-Algorithm|GC 알고리즘 (Orinoco, Tri-color Marking, Parallel/Incremental/Concurrent, Work Stealing)]]
- [x] [[tech/os-runtime/jvm/JVM-GC|JVM GC (Young/Old/Metaspace, Minor vs Full GC, G1·ZGC·Shenandoah)]]
- [x] [[tech/os-runtime/jvm/JVM-Architecture|JVM 아키텍처 (ClassLoader·Runtime Data Area·Execution Engine·JIT C1/C2·GraalVM)]]
