---
name: interview-prep
description: Create public-safe company-specific interview preparation documents from a job description URL, resume, portfolio, company stage, and interview round. Use when the user asks for 면접 준비, 면접 분석, 인터뷰 준비, JD 분석, 예상 질문, 역질문, or company-specific fit and technical interview prep.
---
