...
- **필수성과 구매 조정 가능성**: 당장 대체하거나 구매를 미루기 어려울수록 비탄력적이다. 경제학에서 사치재는 소득탄력성이 1보다 큰 재화를 뜻하므로, 사치재라는 이름만으로 가격탄력성을 단정하지 않는다.
...
- **비싼 물건이 탄력적이다** → 가격 수준 하나로 정해지지 않는다. 대체재, 지출 비중, 구매를 미룰 수 있는 시간과 필수성을 함께 봐야 한다.
