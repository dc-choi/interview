...
- **How to apply**: 회고, 피드백, 우선순위, 목표 설정 관련 대화에서 이 가치들을 실천 프레임으로 연결 (예: 회고 → 훌륭한 실패 3조건, 피드백 고민 → Radical Candor와 I-message, 일 많음 → 파격적 집중의 하나만 뽑기). [[성향, 확신 프레임]]의 "되는 이유 찾기" 리프레임과 발전적 의심이 같은 축.
