...
> 2026-06-29 이직 완료로 구직 재진입 계획은 종료됐다. 아래 미완료 체크와 일정은 당시 계획 기록이며 현재 실행 계획이 아니다. 현재 순서는 [[2026-H2-Math-Recommendation-DevOps-Roadmap|2026 하반기 학습 로드맵]]에서 관리한다.
...
- **5월 중 면접 팔로업**: 해당 회사 준비 최우선. SAA 속성 유지, CloudOps 보류 → 옵션 A(SAA 단독)로 축소
...
- **8월 면접 준비**: 재진입 우선, Redis 분산 패턴 축소, 블로그 포기 가능
