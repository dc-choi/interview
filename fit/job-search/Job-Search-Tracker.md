...
| 키노라이츠 (OTT 통합검색·추천, **재지원**) | https://groupby.kr/positions/10649 | ⚠️ **재지원: 25.9.25 메일 지원 → 25.10.2 서류 탈락 → 26.5 groupby 재도전**. 같은 서류 금지 — 자기소개·이력서 fork 필수(5년 컷 방어를 AI워크플로우·이벤트드리븐(SQS)·운영안정성으로 전면 재배치, 아임웹·111%·비누랩스 재지원 패턴). 직전 탈락 사유 미기록이나 **"5년 이상" 컷이 유력**. **대표 백엔드 + DevOps** (5년+), **TS·NestJS·TypeORM·AWS(ECS Fargate/RDS/Lambda/S3/SQS)·GHA — 스택 거의 100% 매치**, 우대 Datadog/OpenSearch/GraphQL Federation/Monorepo. 업무: 백엔드 기술 의사결정·CI/CD·장애대응 = **이력서 4축(자동화·관측성·AI워크플로우·운영안정성)·이벤트드리븐(SQS)과 정합**. **정규직(수습 3개월)**. 회사: 2018 설립·20명·개발 3명·강남, **Series A(2024.04) 누적 48억(카카오벤처스·유니온투자파트너스·LG유플러스)**, 공동대표 공동대표 A·공동대표 B(카뱅처스 출신). **재무: 매출 2024 14.2억→2025 28.1억(+97%)·2025 영업이익 +0.77억 첫 흑자전환**(누적적자 -20억대 태우다 자력 수익성 도달 = 런웨이 압박 완화). 잡플 4.0(6건). 2026초 왓챠 인수 입찰 참여 후 철회(자금여력·야심). **윤회 대비 재무 fit 우위 명확(28억 vs 8억·흑자 vs 적자·정규직 vs 미래청년일자리 6개월) → 윤회 협상 BATNA**. 리스크: ① **"5년 이상" hard cut**(본인 ~4~5년차·직전 4천 중후반) = 유일 진짜 관문, AI워크플로우·이벤트드리븐·운영안정성으로 시니어성 증명 필요, ② 개발 3명 초소규모(단독 책임 = 기회이자 고립), ③ OTT 도메인 무관(스택 매치가 상쇄) |
...
| 에타일렉트로닉스 (Eta-ON, WPT) | https://www.wanted.co.kr/wd/358791 | 백엔드 3년+, **TS/NestJS/Node·MySQL+MongoDB·AWS(EC2/RDS/IoT Core/S3/CodeDeploy)·MQTT/Socket.io/WebSocket·JWT/Passport·GitHub Actions — 스택 거의 100% 매치**, 무선전력전송(WPT) IoT 디바이스 원격 모니터링·제어 플랫폼 — **트라이포드 IoT VMI 도메인과 거의 동형(지금까지 본 공고 중 도메인 매치 최강)**. 회사: 2019 설립·KAIST 창업원·경산 본사·24명(2025.5)·**2024 매출 1억+·캡스톤파트너스 시드**. 리스크: 매출 1억대·24명 = 윤회(~8억·15명)보다 작음, **재무 fit 윤회와 동일 유형 위험**. 윤회 결과·일정에 따라 시도 순서 결정 |
