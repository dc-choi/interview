...
| 순서 보장 | FIFO 큐에서 MessageGroupId 단위 보장. 일반 FIFO 기본 한도는 API 작업별 초당 300회, 최대 10개 배치 시 API 작업별 초당 3,000개 메시지다. 고처리량은 리전별 서비스 할당량과 MessageGroupId 분산을 확인 | 파티션 내 보장 | 큐 내 FIFO |
