...
- MSK(Kafka) 대비 선택 근거: 당시 workload에는 Kafka의 replay와 stream 처리량이 필요하지 않았고 EventBridge+SQS가 broker 운영 부담이 낮았다. MSK 산정 세부 조건이 남아 있지 않아 정확한 금액이나 총비용 우위는 단정하지 않음
