...
코드를 짜는 것만이 백엔드가 아니다. **한 서비스를 처음부터 운영까지 끌고 갈 때 반드시 다뤄야 하는 최소 결정, 구현 항목**. 신입~주니어가 사수 없이 혼자 해야 하는 상황에서 어디를 놓치기 쉬운지 체크하는 용도.
...
- [[Backend-Study-Order|백엔드 공부 순서]] — 기초 흐름 구간의 입문 학습 순서 (요청 흐름 먼저)
